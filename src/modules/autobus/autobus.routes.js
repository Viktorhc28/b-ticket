...
const { index, view, destroy, update, create } = require('./autobus.controller');
...
router.post('/create', [/* validarJWT, tieneRole(1), */ check('autobus.placa', 'La placa es obligatoria').notEmpty(),existePlaca], create);
